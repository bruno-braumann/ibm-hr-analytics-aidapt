...
IBM HR Analytics Employee Attrition & Performance, sourced from Kaggle.
...
TableTypeDescriptiond_employeeDimensionEmployee demographics and derived fieldsd_departmentDimensionDepartmentsd_job_roleDimensionJob roles and levelsd_educationDimensionEducation level and fieldf_employee_movementFactEmployment, compensation, and performance dataf_satisfactionFactSatisfaction metrics (baseline)f_satisfaction_historyFactSatisfaction history: before and after Ping Pong
